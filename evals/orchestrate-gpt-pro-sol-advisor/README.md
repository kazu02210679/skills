...
uses the installed allowlisted runtime inspector only to fill omitted fields
for the exact same thread, rejects conflicting overlap, and records per-field
